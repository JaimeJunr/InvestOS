...
- [Começando](instalacao/comecando.md) — requisitos, criando o primeiro portfólio, primeiros comandos.

## Arquitetura

- [Visão geral](arquitetura/visao-geral.md) — estrutura de um portfólio, o padrão declarativo de MCP, fontes de dados BR.

## Desenvolvimento

- [Desenvolvendo e contribuindo](desenvolvimento/contribuindo.md) — rodar testes, convenções, processo de mudança de escopo.
...
- Features:
  ...
  - [Catálogo de Plugins](produto/features/catalogo-de-plugins.md)
